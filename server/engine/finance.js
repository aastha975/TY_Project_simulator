...
const CAPEX_LOOKUP = {
  ...
  routeOptimizationFixedCost: 25000,
...
function calculateFinancials(currentEmissionsResult, baselineEmissionsResult, currentLevers, baselineLevers) {
  ...
  // Route optimization CapEx
  if (currentLevers.routeOptimisationPercent > (baselineLevers.routeOptimisationPercent || 0)) {
    totalCapExINR += CAPEX_LOOKUP.routeOptimizationFixedCost;
  }
